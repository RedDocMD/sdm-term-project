...
# ╔═╡ 75392bce-4376-11ec-3b27-e3594fe57ad4
begin
	using Plots
	using PlotlyJS
	plotlyjs()
...
# ╔═╡ 5b4bd32d-f39b-4228-8b89-59f60164c150
begin
	x = 1:10
	y = x .^ 2
	p = Plots.plot(x, y)
...
# ╔═╡ a2e08243-f653-48e2-8663-fa80f7316cf3
Plots.savefig(p, "/home/dknite/Documents/plot.eps")
